...
CREATE TABLE notification (
  ...
  work_week_monday_start_time TIME WITHOUT TIME ZONE,
  work_week_monday_end_time TIME WITHOUT TIME ZONE,
  work_week_tuesday_start_time TIME WITHOUT TIME ZONE,
  work_week_tuesday_end_time TIME WITHOUT TIME ZONE,
  work_week_wednesday_start_time TIME WITHOUT TIME ZONE,
  work_week_wednesday_end_time TIME WITHOUT TIME ZONE,
  work_week_thursday_start_time TIME WITHOUT TIME ZONE,
  work_week_thursday_end_time TIME WITHOUT TIME ZONE,
  work_week_friday_start_time TIME WITHOUT TIME ZONE,
  work_week_friday_end_time TIME WITHOUT TIME ZONE,
  work_week_saturday_start_time TIME WITHOUT TIME ZONE,
  work_week_saturday_end_time TIME WITHOUT TIME ZONE,
  work_week_sunday_start_time TIME WITHOUT TIME ZONE,
  work_week_sunday_end_time TIME WITHOUT TIME ZONE
);
